 ...
 */
package edu.teilar.jcrop.owl.datafactory;
...
public class CROPOWLDataFactoryImpl extends OWLDataFactoryImpl {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 501962936325236122L;
	...
	public OWLNamedIndividual getXGraphEdgeIndi(
			String fromXNodeLabel, String fromXNodeType,
			String toXNodeLabel, String toXNodeType, 
	...
	/**
	 * 
	 * @param xNodeFragment, e.g. From_1_ControlNode_To_Operation_Default_complex3_XGraphEdge
	 * @return
	 */
	public OWLNamedIndividual getXGraphEdgeIndi(String xNodeFragment) {
		return getOWLNamedIndividual(xNodeFragment, OntoUtil.GraphPM);
	}
	...
	public OWLNamedIndividual getXGraphIndi(String xGraphName) {
		return getOWLNamedIndividual(":" + xGraphName, OntoUtil.XGraphPM);
	}
	...
	public OWLNamedIndividual getTaxonPathIndi(KObject kobj) {
		return getOWLNamedIndividual(":" + kobj.getTargetEducationalObjective().getName()
	...
	public OWLNamedIndividual getXNodeIndi(String name, XNodeType type,
			String xGraphName, String kObjectName) {
	...
	public OWLNamedIndividual getLearningActNodeIndi(String name) {
		return getOWLNamedIndividual(":"+ name, OntoUtil.XGraphPM);
	}
	
	public OWLNamedIndividual getIndiforXGraphPM(String fragment) {
		return getOWLNamedIndividual(":"+ fragment, OntoUtil.XGraphPM);
	}
	...
	public OWLNamedIndividual getDialogueNodeIndi(String fragment) {
		return getOWLNamedIndividual(":" + fragment, OntoUtil.XGraphPM);
	}
	...
	public OWLNamedIndividual getControlNodeIndi(String fragment) {
		return getOWLNamedIndividual(":" + fragment, OntoUtil.XGraphPM);
	}
	...
	public OWLNamedIndividual getParGroupIndi(String fragment) {
		return getOWLNamedIndividual(":" + fragment, OntoUtil.XGraphPM);
	}
	...
	public OWLClass getIfFalseEdge() {
		return getOWLClass(":IfFalseEdge", OntoUtil.GraphPM);
	}
	
	public OWLClass getIfTrueEdge() {
		return getOWLClass(":IfTrueEdge", OntoUtil.GraphPM);
	}
	...
	public OWLClass getKObjectByType(KObject kobj) {
		if(kobj instanceof KResourceAssessment) {
			return getOWLClass(IRI.create(
				"http://www.cs.teilar.gr/ontologies/KObject.owl#KResourceAssessment"));
		} else if(kobj instanceof KResourceSupport) {
			return getOWLClass(IRI.create(
				"http://www.cs.teilar.gr/ontologies/KObject.owl#KResourceSupport"));
		} else if(kobj instanceof KProduct) {
			return getOWLClass(IRI.create(
	...
	public OWLClass getXNode(XNodeType type) {
		if(type == XNodeType.Control) {
			return getControlNode();
		} else if(type == XNodeType.Dialogue) {
			return getDialogueNode();
		} else if(type == XNodeType.LearningAct) {
	...
	/** Data Properties **/
	public OWLDataProperty getHasPriorityList() {
		return getOWLDataProperty(IRI.create(
			"http://www.cs.teilar.gr/ontologies/XModel.owl#hasPriorityList"));
	}
	
	public OWLDataProperty getHasVerboseLevel() {
		return getOWLDataProperty(IRI.create(
		"http://www.cs.teilar.gr/ontologies/XModel.owl#hasVerboseLevel"));
	}
	
	public OWLDataProperty getHasAlgorithm() {
		return getOWLDataProperty(IRI.create(
